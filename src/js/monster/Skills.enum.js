...
FLASH: {name: 'Flash', type: Types.NORMAL, power: 0, accuracy: 100, effect: Effects.LOWER_STAT, pp: 20, damagetype: 'STAT', params: {stat: "ACC"}},
GROWL: {name: 'Growl', type: Types.NORMAL, power: 0, accuracy: 100, effect: Effects.LOWER_STAT, pp: 40, damagetype: 'STAT', params: {stat: "ATK"}},
KINESIS: {name: 'Kinesis', type: Types.PSYCHIC, power: 0, accuracy: 80, effect: Effects.LOWER_STAT, pp: 15, damagetype: 'STAT', params: {stat: "ACC"}},
LEER: {name: 'Leer', type: Types.NORMAL, power: 0, accuracy: 100, effect: Effects.LOWER_STAT, pp: 30, damagetype: 'STAT', params: {stat: "DEF"}},
SAND_ATTACK: {name: 'Sand Attack', type: Types.GROUND, power: 0, accuracy: 100, effect: Effects.LOWER_STAT, pp: 15, damagetype: 'STAT', params: {stat: "ACC"}},
SCREECH: {name: 'Screech', type: Types.NORMAL, power: 0, accuracy: 85, effect: Effects.LOWER_STAT, pp: 40, damagetype: 'STAT', params: {stat: "DEF", level: 2}},
SMOKESCREEN: {name: 'Smokescreen', type: Types.NORMAL, power: 0, accuracy: 100, effect: Effects.LOWER_STAT, pp: 20, damagetype: 'STAT', params: {stat: "ACC"}},
STRING_SHOT: {name: 'String Shot', type: Types.BUG, power: 0, accuracy: 95, effect: Effects.LOWER_STAT, pp: 40, damagetype: 'STAT', params: {stat: "SPD", level: 2}},
TAIL_WHIP: {name: 'Tail Whip', type: Types.NORMAL, power: 0, accuracy: 100, effect: Effects.LOWER_STAT, pp: 30, damagetype: 'STAT', params: {stat: "DEF"}},
