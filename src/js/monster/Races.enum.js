...
var Races = {
BULBASAUR: new Race('Saurbulba', 'b', 85, 255, 85, true, Types.GRASS, Types.POISON, 45, 49, 49, 65, 65, 45, 64),
IVYSAUR: new Race('Saurivy', 'i', 85, 255, 85, true, Types.GRASS, Types.POISON, 60, 62, 63, 80, 80, 60, 141),
VENUSAUR: new Race('Saurvenu', 'V', 85, 255, 85, true, Types.GRASS, Types.POISON, 80, 82, 83, 100, 100, 80, 208),
CHARMANDER: new Race('Manderchar', 'c', 255, 85, 85, true, Types.FIRE, null, 39, 52, 43, 60, 50, 65, 65),
CHARMELEON: new Race('Meleonchar', 'c', 255, 85, 85, true, Types.FIRE, null, 58, 64, 58, 80, 65, 80, 142),
CHARIZARD: new Race('Zardchari', 'C', 255, 85, 85, true, Types.FIRE, Types.FLYING, 78, 84, 78, 109, 85, 100, 209),
SQUIRTLE: new Race('Tlesquir', 's', 85, 85, 255, true, Types.WATER, null, 44, 48, 65, 50, 64, 43, 66),
WARTORTLE: new Race('Tlewartor', 'w', 85, 85, 255, true, Types.WATER, null, 59, 63, 80, 65, 80, 58, 143),
BLASTOISE: new Race('Toiseblas', 'B', 85, 85, 255, true, Types.WATER, null, 79, 83, 100, 85, 105, 78, 210),
CATERPIE: new Race('Piecater', 'c', 85, 255, 85, false, Types.BUG, null, 45, 30, 35, 20, 20, 45, 53),
METAPOD: new Race('Podmeta', 'm', 85, 255, 85, false, Types.BUG, null, 50, 20, 55, 25, 25, 30, 72),
BUTERFREE: new Race('Freebutter', 'b', 255, 255, 255, false, Types.BUG, Types.FLYING, 60, 45, 50, 80, 80, 70, 160),
WEEDLE: new Race('Dlewee', 'w', 170, 85, 0, false, Types.BUG, Types.POISON, 40, 35, 30, 20, 20, 50, 52),
KAKUNA: new Race('Kunaka', 'k', 255, 255, 85, false, Types.BUG, Types.POISON, 45, 25, 50, 25, 25, 35, 71),
BEEDRILL: new Race('Drillbee', 'b', 255, 255, 85, true, Types.BUG, Types.POISON, 65, 80, 40, 45, 80, 75, 159),
PIDGEY: new Race('Geypi', 'p', 170, 85, 0, false, Types.NORMAL, Types.FLYING, 40, 45, 40, 35, 35, 56, 55),
PIDGEOTTO: new Race('Geottopi', 'p', 170, 85, 0, true, Types.NORMAL, Types.FLYING, 63, 60, 55, 50, 50, 71, 113),
PIDGEOT: new Race('Geotpi', 'P', 170, 85, 0, true, Types.NORMAL, Types.FLYING, 83, 80, 75, 70, 70, 91, 172),
RATTATA: new Race('Tatarat', 'r', 170, 0, 170, true, Types.NORMAL, null, 30, 56, 35, 25, 35, 72, 57),
RATICATE: new Race('Caterati', 'R', 170, 85, 0, true, Types.NORMAL, null, 55, 81, 60, 50, 70, 97, 116),
SPEAROW: new Race('Rowspea', 's', 170, 85, 0, true, Types.NORMAL, Types.FLYING, 40, 60, 30, 31, 31, 70, 58),
FEAROW: new Race('Rowfea', 'F', 170, 85, 0, true, Types.NORMAL, Types.FLYING, 65, 90, 65, 61, 61, 100, 162),
EKANS: new Race('Ansek', 'e', 170, 0, 170, true, Types.POISON, null, 30, 60, 44, 40, 54, 55, 62),
ARBOK: new Race('Bokar', 'a', 170, 0, 170, true, Types.POISON, null, 60, 85, 69, 65, 79, 80, 147),
PIKACHU: new Race('Chupika', 'p', 255, 255, 85, true, Types.ELECTRIC, null, 35, 55, 30, 50, 40, 90, 82),
RAICHU: new Race('Churai', 'R', 255, 255, 85, true, Types.ELECTRIC, null, 60, 90, 55, 90, 80, 100, 122),
SANDSHREW: new Race('Shrewsand', 's', 255, 255, 85, true, Types.GROUND, null, 50, 75, 85, 20, 30, 40, 93),
SANDSLASH: new Race('Slashsand', 'S', 255, 255, 85, true, Types.GROUND, null, 75, 100, 110, 45, 55, 65, 163),
NIDORAN_F: new Race('Rannido♀', 'n', 85, 85, 255, false, Types.POISON, null, 55, 47, 52, 40, 40, 41, 59),
NIDORINA: new Race('Rinanido', 'n', 85, 85, 255, true, Types.POISON, null, 70, 62, 67, 55, 55, 56, 117),
NIDOQUEEN: new Race('Quennido', 'N', 85, 85, 255, true, Types.POISON, Types.GROUND, 90, 82, 87, 75, 85, 76, 194),
NIDORAN_M: new Race('Rannido♂', 'n', 170, 0, 170, false, Types.POISON, null, 46, 57, 40, 40, 40, 50, 60),
NIDORINO: new Race('Rinonido', 'n', 170, 0, 170, true, Types.POISON, null, 61, 72, 57, 55, 55, 65, 118),
NIDOKING: new Race('Kingnido', 'N', 170, 0, 170, true, Types.POISON, Types.GROUND, 81, 92, 77, 85, 75, 85, 195),
CLEFAIRY: new Race('Fairycle', 'c', 255, 85, 255, false, Types.NORMAL, null, 70, 45, 48, 60, 65, 35, 68),
CLEFABLE: new Race('Fablecle', 'C', 255, 85, 255, false, Types.NORMAL, null, 95, 70, 73, 85, 90, 60, 129),
VULPIX: new Race('Pixvul', 'v', 170, 85, 0, false, Types.FIRE, null, 38, 41, 40, 50, 65, 65, 63),
NINETALES: new Race('Talesnine', 'N', 255, 255, 85, true, Types.FIRE, null, 73, 76, 75, 81, 100, 100, 178),
JIGGLYPUFF: new Race('Puffjiggly', 'j', 255, 85, 255, false, Types.NORMAL, null, 115, 45, 20, 45, 25, 20, 76),
WIGGLYTUFF: new Race('Tuffwiggly', 'w', 255, 85, 255, true, Types.NORMAL, null, 140, 70, 45, 75, 50, 45, 109),
ZUBAT: new Race('Batzu', 'z', 170, 0, 170, false, Types.POISON, Types.FLYING, 40, 45, 35, 30, 40, 55, 54),
GOLBAT: new Race('Batgol', 'G', 170, 0, 170, true, Types.POISON, Types.FLYING, 75, 80, 70, 65, 75, 90, 171),
ODDISH: new Race('Shoddi', 'o', 85, 85, 255, false, Types.GRASS, Types.POISON, 45, 50, 55, 75, 65, 30, 78),
GLOOM: new Race('Mgloo', 'g', 85, 85, 255, false, Types.GRASS, Types.POISON, 60, 65, 70, 85, 75, 40, 132),
VILEPLUME: new Race('Plumevile', 'V', 255, 85, 85, false, Types.GRASS, Types.POISON, 75, 80, 85, 100, 90, 50, 184),
PARAS: new Race('Raspa', 'p', 255, 85, 85, false, Types.BUG, Types.GRASS, 35, 70, 55, 45, 55, 25, 70),
PARASECT: new Race('Rasectpa', 'P', 255, 85, 85, true, Types.BUG, Types.GRASS, 60, 95, 80, 60, 80, 30, 128),
VENONAT: new Race('Natveno', 'v', 170, 0, 170, true, Types.BUG, Types.POISON, 60, 55, 50, 40, 55, 45, 75),
VENOMOTH: new Race('Mothveno', 'v', 170, 0, 170, true, Types.BUG, Types.POISON, 70, 65, 60, 90, 75, 90, 138),
DIGLETT: new Race('Glettdi', 'd', 170, 85, 0, true, Types.GROUND, null, 10, 55, 25, 35, 45, 95, 81),
DUGTRIO: new Race('Triodug', 'd', 170, 85, 0, true, Types.GROUND, null, 35, 80, 50, 50, 70, 120, 153),
MEOWTH: new Race('Owthme', 'm', 255, 255, 85, true, Types.NORMAL, null, 40, 45, 35, 40, 40, 90, 69),
PERSIAN: new Race('Sianper', 'p', 255, 255, 85, true, Types.NORMAL, null, 65, 70, 60, 65, 65, 115, 148),
PSYDUCK: new Race('Duckpsy', 'p', 255, 255, 85, false, Types.WATER, null, 50, 52, 48, 65, 50, 55, 80),
GOLDUCK: new Race('Duckgold', 'g', 85, 85, 255, true, Types.WATER, null, 80, 82, 78, 95, 80, 85, 174),
MANKEY: new Race('Keyman', 'm', 170, 85, 0, true, Types.FIGHTING, null, 40, 80, 35, 35, 45, 70, 74),
PRIMEAPE: new Race('Apeprime', 'p', 170, 85, 0, true, Types.FIGHTING, null, 65, 105, 60, 60, 70, 95, 149),
GROWLITHE: new Race('Lithegrow', 'g', 170, 85, 0, true, Types.FIRE, null, 55, 70, 45, 70, 50, 60, 91),
ARCANINE: new Race('Ninearca', 'A', 170, 85, 0, true, Types.FIRE, null, 90, 110, 80, 100, 80, 95, 213),
POLIWAG: new Race('Wagpoli', 'p', 85, 85, 255, false, Types.WATER, null, 40, 50, 40, 40, 40, 90, 77),
POLIWHIRL: new Race('Whirlpoli', 'p', 85, 85, 255, true, Types.WATER, null, 65, 65, 65, 50, 50, 90, 131),
POLIWRATH: new Race('Wrathpoli', 'P', 85, 85, 255, true, Types.WATER, Types.FIGHTING, 90, 85, 95, 70, 90, 70, 185),
ABRA: new Race('Arba', 'a', 170, 85, 0, false, Types.PSYCHIC, null, 25, 20, 15, 105, 55, 90, 73),
KADABRA: new Race('Abrakad', 'k', 170, 85, 0, true, Types.PSYCHIC, null, 40, 35, 30, 120, 70, 105, 145),
ALAKAZAM: new Race('Zamalaka', 'A', 170, 85, 0, true, Types.PSYCHIC, null, 55, 50, 45, 135, 85, 120, 186),
MACHOP: new Race('Chopma', 'm', 170, 170, 170, true, Types.FIGHTING, null, 70, 80, 50, 35, 35, 35, 88),
MACHOKE: new Race('Chokema', 'm', 170, 170, 170, true, Types.FIGHTING, null, 80, 100, 70, 50, 60, 45, 146),
MACHAMP: new Race('Champma', 'M', 170, 170, 170, true, Types.FIGHTING, null, 90, 130, 80, 65, 85, 55, 193),
BELLSPROUT: new Race('Sproutbell', 'b', 85, 255, 85, false, Types.GRASS, Types.POISON, 50, 75, 35, 70, 30, 40, 84),
WEEPINBELL: new Race('Bellweepin', 'w', 85, 255, 85, false, Types.GRASS, Types.POISON, 65, 90, 50, 85, 45, 55, 151),
VICTREEBEL: new Race('Treebelvic', 'V', 85, 255, 85, true, Types.GRASS, Types.POISON, 80, 105, 65, 100, 60, 70, 191),
TENTACOOL: new Race('Cooltenta', 't', 85, 85, 255, true, Types.WATER, Types.POISON, 40, 40, 35, 50, 100, 70, 105),
TENTACRUEL: new Race('Crueltenta', 't', 85, 85, 255, true, Types.WATER, Types.POISON, 80, 70, 65, 80, 120, 100, 205),
GEODUDE: new Race('Dudegeo', 'g', 170, 85, 0, true, Types.ROCK, Types.GROUND, 40, 80, 100, 30, 30, 20, 86),
GRAVELER: new Race('Velergra', 'G', 170, 85, 0, true, Types.ROCK, Types.GROUND, 55, 95, 115, 45, 45, 35, 134),
GOLEM: new Race('Lemgo', 'G', 170, 85, 0, true, Types.ROCK, Types.GROUND, 80, 110, 130, 55, 65, 45, 177),
PONYTA: new Race('Tapony', 'p', 255, 255, 85, false, Types.FIRE, null, 50, 85, 55, 65, 65, 90, 152),
RAPIDASH: new Race('Dashrapi', 'R', 255, 255, 85, false, Types.FIRE, null, 65, 100, 70, 80, 80, 105, 192),
SLOWPOKE: new Race('Pokeslow', 's', 255, 85, 255, false, Types.WATER, Types.PSYCHIC, 90, 65, 65, 40, 40, 15, 99),
SLOWBRO: new Race('Broslow', 's', 255, 85, 255, false, Types.WATER, Types.PSYCHIC, 95, 75, 110, 100, 80, 30, 164),
MAGNEMITE: new Race('Mitemagne', 'm', 170, 170, 170, true, Types.ELECTRIC, Types.STEEL, 25, 35, 70, 95, 55, 45, 89),
MAGNETON: new Race('Tonmagne', 'm', 170, 170, 170, true, Types.ELECTRIC, Types.STEEL, 50, 60, 95, 120, 70, 70, 161),
FARFETCHD: new Race('Fetfarch\'d', 'f', 170, 85, 0, true, Types.NORMAL, Types.FLYING, 52, 65, 55, 58, 62, 60, 94),
DODUO: new Race('Duodo', 'd', 170, 85, 0, true, Types.NORMAL, Types.FLYING, 35, 85, 45, 35, 35, 75, 96),
DODRIO: new Race('Driodo', 'd', 170, 85, 0, true, Types.NORMAL, Types.FLYING, 60, 110, 70, 60, 60, 100, 158),
SEEL: new Race('Lees', 's', 255, 255, 255, false, Types.WATER, null, 65, 45, 55, 45, 70, 45, 100),
DEWGONG: new Race('Gongdew', 'd', 255, 255, 255, true, Types.WATER, Types.ICE, 90, 70, 80, 70, 95, 70, 176),
GRIMER: new Race('Mergri', 'g', 170, 0, 170, true, Types.POISON, null, 80, 80, 50, 40, 50, 25, 90),
MUK: new Race('Kum', 'm', 170, 0, 170, true, Types.POISON, null, 105, 105, 75, 65, 100, 50, 157),
SHELLDER: new Race('Dershell', 's', 170, 0, 170, false, Types.WATER, null, 30, 65, 100, 45, 25, 40, 97),
CLOYSTER: new Race('Stercloy', 'c', 170, 0, 170, true, Types.WATER, Types.ICE, 50, 90, 180, 85, 45, 70, 203),
GASTLY: new Race('Tlygas', 'g', 170, 0, 170, true, Types.GHOST, Types.POISON, 30, 35, 30, 100, 35, 80, 95),
HAUNTER: new Race('Terhaun', 'h', 170, 0, 170, true, Types.GHOST, Types.POISON, 45, 50, 45, 115, 55, 95, 126),
GENGAR: new Race('Gargen', 'G', 170, 0, 170, true, Types.GHOST, Types.POISON, 60, 65, 60, 130, 75, 110, 190),
ONIX: new Race('Nixo', 'O', 170, 170, 170, true, Types.ROCK, Types.GROUND, 35, 45, 160, 30, 45, 70, 108),
DROWZEE: new Race('Zeedrow', 'd', 255, 255, 85, false, Types.PSYCHIC, null, 60, 48, 45, 43, 90, 42, 102),
HYPNO: new Race('Nohyp', 'h', 255, 255, 85, false, Types.PSYCHIC, null, 85, 73, 70, 73, 115, 67, 165),
KRABBY: new Race('Bykrab', 'k', 255, 85, 85, false, Types.WATER, null, 30, 105, 90, 25, 25, 50, 115),
KINGLER: new Race('Glerking', 'K', 255, 85, 85, true, Types.WATER, null, 55, 130, 115, 50, 50, 75, 206),
VOLTORB: new Race('Orbvolt', 'v', 255, 85, 85, true, Types.ELECTRIC, null, 40, 30, 50, 55, 55, 100, 103),
ELECTRODE: new Race('Trodelect', 'E', 255, 85, 85, true, Types.ELECTRIC, null, 60, 50, 70, 80, 80, 140, 150),
EXEGGCUTE: new Race('Cutexegg', 'e', 255, 85, 255, true, Types.GRASS, Types.PSYCHIC, 60, 40, 80, 60, 45, 40, 98),
EXEGGUTOR: new Race('Gutorexegg', 'E', 255, 255, 85, true, Types.GRASS, Types.PSYCHIC, 95, 95, 85, 125, 65, 55, 212),
CUBONE: new Race('Bonecu', 'c', 170, 85, 0, true, Types.GROUND, null, 50, 50, 95, 40, 50, 35, 87),
MAROWAK: new Race('Wakmaro', 'm', 170, 85, 0, true, Types.GROUND, null, 60, 80, 110, 50, 80, 45, 124),
HITMONLEE: new Race('Leehitmon', 'h', 170, 85, 0, true, Types.FIGHTING, null, 50, 120, 53, 35, 110, 87, 139),
HITMONCHAN: new Race('Chanhitmon', 'h', 170, 85, 0, true, Types.FIGHTING, null, 50, 105, 79, 35, 110, 76, 140),
LICKITUNG: new Race('Tunglicki', 'l', 255, 85, 255, true, Types.NORMAL, null, 90, 55, 75, 60, 75, 30, 127),
KOFFING: new Race('Fingkof', 'k', 170, 0, 170, true, Types.POISON, null, 40, 65, 95, 60, 45, 35, 114),
WEEZING: new Race('Zingwee', 'w', 170, 0, 170, true, Types.POISON, null, 65, 90, 120, 85, 70, 60, 173),
RHYHORN: new Race('Hornrhy', 'R', 170, 170, 170, true, Types.GROUND, Types.ROCK, 80, 85, 95, 30, 30, 25, 135),
RHYDON: new Race('Donrhy', 'R', 170, 170, 170, true, Types.GROUND, Types.ROCK, 105, 130, 120, 45, 45, 40, 204),
CHANSEY: new Race('Seychan', 'c', 255, 85, 255, false, Types.NORMAL, null, 250, 5, 5, 35, 105, 50, 255),
TANGELA: new Race('Gelatan', 't', 85, 85, 255, false, Types.GRASS, null, 65, 55, 115, 100, 40, 60, 166),
KANGASKHAN: new Race('Khankangas', 'K', 170, 85, 0, true, Types.NORMAL, null, 105, 95, 80, 40, 80, 90, 175),
HORSEA: new Race('Seahor', 'h', 85, 85, 255, false, Types.WATER, null, 30, 40, 70, 70, 25, 60, 83),
SEADRA: new Race('Drasea', 's', 85, 85, 255, true, Types.WATER, null, 55, 65, 95, 95, 45, 85, 155),
GOLDEEN: new Race('Deengol', 'g', 255, 85, 85, false, Types.WATER, null, 45, 67, 60, 35, 50, 63, 111),
SEAKING: new Race('Kingsea', 'S', 255, 85, 85, true, Types.WATER, null, 80, 92, 65, 65, 80, 68, 170),
STARYU: new Race('Yustar', 's', 170, 85, 0, true, Types.WATER, null, 30, 45, 55, 70, 55, 85, 106),
STARMIE: new Race('Miestar', 's', 170, 0, 170, true, Types.WATER, Types.PSYCHIC, 60, 75, 85, 100, 85, 115, 207),
MR_MIME: new Race('Mr. Memi', 'm', 255, 85, 255, false, Types.PSYCHIC, null, 40, 45, 65, 100, 120, 90, 136),
SCYTHER: new Race('Therscy', 's', 85, 255, 85, true, Types.BUG, Types.FLYING, 70, 110, 80, 55, 80, 105, 187),
JYNX: new Race('Icycool', 'j', 255, 85, 85, false, Types.ICE, Types.PSYCHIC, 65, 50, 35, 115, 95, 95, 137),
ELECTABUZZ: new Race('Buzzelecta', 'e', 255, 255, 85, true, Types.ELECTRIC, null, 65, 83, 57, 95, 85, 105, 156),
MAGMAR: new Race('Marmag', 'm', 255, 85, 85, true, Types.FIRE, null, 65, 95, 57, 100, 85, 93, 167),
PINSIR: new Race('Sirpin', 'p', 170, 85, 0, true, Types.BUG, null, 65, 125, 100, 55, 70, 85, 200),
TAUROS: new Race('Rostau', 'T', 170, 85, 0, true, Types.NORMAL, null, 75, 100, 95, 40, 70, 110, 211),
MAGIKARP: new Race('Karpmagi', 'm', 255, 85, 85, false, Types.WATER, null, 20, 10, 55, 15, 20, 80, 20),
GYARADOS: new Race('Radosgya', 'G', 85, 85, 255, true, Types.WATER, Types.FLYING, 95, 125, 79, 60, 100, 81, 214),
LAPRAS: new Race('Prasla', 'L', 85, 85, 255, true, Types.WATER, Types.ICE, 130, 85, 80, 85, 95, 60, 219),
DITTO: new Race('Todit', 'd', 170, 0, 170, true, Types.NORMAL, null, 48, 48, 48, 48, 48, 48, 61),
EEVEE: new Race('Eon', 'e', 170, 85, 0, true, Types.NORMAL, null, 55, 55, 50, 45, 65, 55, 92),
VAPOREON: new Race('Eonvapor', 'v', 85, 85, 255, true, Types.WATER, null, 130, 65, 60, 110, 95, 65, 196),
JOLTEON: new Race('Eonjolt', 'j', 255, 255, 85, true, Types.ELECTRIC, null, 65, 65, 60, 110, 95, 130, 197),
FLAREON: new Race('Eonflar', 'f', 255, 85, 85, true, Types.FIRE, null, 65, 130, 60, 95, 110, 65, 198),
PORYGON: new Race('Gonpory', 'p', 255, 85, 255, true, Types.NORMAL, null, 65, 60, 70, 85, 75, 40, 130),
OMANYTE: new Race('Nyteoma', 'o', 85, 85, 255, true, Types.ROCK, Types.WATER, 35, 40, 100, 90, 55, 35, 120),
OMASTAR: new Race('Staroma', 'o', 85, 85, 255, true, Types.ROCK, Types.WATER, 70, 60, 125, 115, 70, 55, 199),
KABUTO: new Race('Butoka', 'k', 170, 85, 0, true, Types.ROCK, Types.WATER, 30, 80, 90, 55, 45, 55, 119),
KABUTOPS: new Race('Butopska', 'K', 170, 85, 0, true, Types.ROCK, Types.WATER, 60, 115, 105, 65, 70, 80, 201),
AERODACTYL: new Race('Dactylaero', 'A', 170, 0, 170, true, Types.ROCK, Types.FLYING, 80, 105, 65, 60, 75, 130, 202),
SNORLAX: new Race('Laxsnor', 'S', 85, 85, 85, false, Types.NORMAL, null, 160, 110, 65, 65, 110, 30, 154),
ARTICUNO: new Race('Cunoarti', 'A', 85, 85, 255, true, Types.ICE, Types.FLYING, 90, 85, 100, 95, 125, 85, 215),
ZAPDOS: new Race('Doszap', 'Z', 255, 255, 85, true, Types.ELECTRIC, Types.FLYING, 90, 90, 85, 125, 90, 100, 216),
MOLTRES: new Race('Tresmol', 'M', 255, 255, 85, true, Types.FIRE, Types.FLYING, 90, 100, 90, 125, 85, 90, 217),
DRATINI: new Race('Trinidra', 'd', 85, 85, 255, true, Types.DRAGON, null, 41, 64, 45, 50, 50, 50, 67),
DRAGONAIR: new Race('Gonairdra', 'd', 85, 85, 255, true, Types.DRAGON, null, 61, 84, 65, 70, 70, 70, 144),
DRAGONITE: new Race('Gonitedra', 'D', 170, 85, 0, true, Types.DRAGON, Types.FLYING, 91, 134, 95, 100, 100, 80, 218),
MEWTWO: new Race('Twomew', 'M', 170, 0, 170, true, Types.PSYCHIC, null, 106, 110, 90, 154, 90, 130, 220),
MEW: new Race('Wem', 'm', 255, 85, 255, true, Types.PSYCHIC, null, 100, 100, 100, 100, 100, 100, 64)
};
