...
var Races = {
BULBASAUR: {name: 'Bulbasaur', tile: new ut.Tile('b', 85, 255, 85), aggressive: true, type: Types.GRASS, hp: 45, attack:49, defense: 49, spAttack:65, spDefense:65, speed: 45, xp: 64, skills: []},
IVYSAUR: {name: 'Ivysaur', tile: new ut.Tile('i', 85, 255, 85), aggressive: true, type: Types.GRASS, hp: 60, attack:62, defense: 63, spAttack:80, spDefense:80, speed: 60, xp: 141, skills: []},
VENUSAUR: {name: 'Venusaur', tile: new ut.Tile('V', 85, 255, 85), aggressive: true, type: Types.GRASS, hp: 80, attack:82, defense: 83, spAttack:100, spDefense:100, speed: 80, xp: 208, skills: []},
...
CHARIZARD: {name: 'Charizard', tile: new ut.Tile('C', 255, 85, 85), aggressive: true, type: Types.FIRE, hp: 78, attack:84, defense: 78, spAttack:109, spDefense:85, speed: 100, xp: 209, skills: []},
...
BUTERFREE: {name: 'Butterfree', tile: new ut.Tile('b', 255, 255, 255), aggressive: false, type: Types.BUG, hp: 60, attack:45, defense: 50, spAttack:80, spDefense:80, speed: 70, xp: 160, skills: []},
WEEDLE: {name: 'Weedle', tile: new ut.Tile('w', 170, 85, 0), aggressive: false, type: Types.BUG, hp: 40, attack:35, defense: 30, spAttack:20, spDefense:20, speed: 50, xp: 52, skills: []},
KAKUNA: {name: 'Kakuna', tile: new ut.Tile('k', 255, 255, 85), aggressive: false, type: Types.BUG, hp: 45, attack:25, defense: 50, spAttack:25, spDefense:25, speed: 35, xp: 71, skills: []},
BEEDRILL: {name: 'Beedrill', tile: new ut.Tile('b', 255, 255, 85), aggressive: true, type: Types.BUG, hp: 65, attack:80, defense: 40, spAttack:45, spDefense:80, speed: 75, xp: 159, skills: []},
PIDGEY: {name: 'Pidgey', tile: new ut.Tile('p', 170, 85, 0), aggressive: false, type: Types.NORMAL, hp: 40, attack:45, defense: 40, spAttack:35, spDefense:35, speed: 56, xp: 55, skills: []},
PIDGEOTTO: {name: 'Pidgeotto', tile: new ut.Tile('p', 170, 85, 0), aggressive: true, type: Types.NORMAL, hp: 63, attack:60, defense: 55, spAttack:50, spDefense:50, speed: 71, xp: 113, skills: []},
PIDGEOT: {name: 'Pidgeot', tile: new ut.Tile('P', 170, 85, 0), aggressive: true, type: Types.NORMAL, hp: 83, attack:80, defense: 75, spAttack:70, spDefense:70, speed: 91, xp: 172, skills: []},
...
SPEAROW: {name: 'Spearow', tile: new ut.Tile('s', 170, 85, 0), aggressive: true, type: Types.NORMAL, hp: 40, attack:60, defense: 30, spAttack:31, spDefense:31, speed: 70, xp: 58, skills: []},
FEAROW: {name: 'Fearow', tile: new ut.Tile('F', 170, 85, 0), aggressive: true, type: Types.NORMAL, hp: 65, attack:90, defense: 65, spAttack:61, spDefense:61, speed: 100, xp: 162, skills: []},
...
NIDOQUEEN: {name: 'Nidoqueen', tile: new ut.Tile('N', 85, 85, 255), aggressive: true, type: Types.POISON, hp: 90, attack:82, defense: 87, spAttack:75, spDefense:85, speed: 76, xp: 194, skills: []},
...
NIDOKING: {name: 'Nidoking', tile: new ut.Tile('N', 170, 0, 170), aggressive: true, type: Types.POISON, hp: 81, attack:92, defense: 77, spAttack:85, spDefense:75, speed: 85, xp: 195, skills: []},
...
ZUBAT: {name: 'Zubat', tile: new ut.Tile('z', 170, 0, 170), aggressive: false, type: Types.POISON, hp: 40, attack:45, defense: 35, spAttack:30, spDefense:40, speed: 55, xp: 54, skills: []},
GOLBAT: {name: 'Golbat', tile: new ut.Tile('G', 170, 0, 170), aggressive: true, type: Types.POISON, hp: 75, attack:80, defense: 70, spAttack:65, spDefense:75, speed: 90, xp: 171, skills: []},
ODDISH: {name: 'Oddish', tile: new ut.Tile('o', 85, 85, 255), aggressive: false, type: Types.GRASS, hp: 45, attack:50, defense: 55, spAttack:75, spDefense:65, speed: 30, xp: 78, skills: []},
GLOOM: {name: 'Gloom', tile: new ut.Tile('g', 85, 85, 255), aggressive: false, type: Types.GRASS, hp: 60, attack:65, defense: 70, spAttack:85, spDefense:75, speed: 40, xp: 132, skills: []},
VILEPLUME: {name: 'Vileplume', tile: new ut.Tile('V', 255, 85, 85), aggressive: false, type: Types.GRASS, hp: 75, attack:80, defense: 85, spAttack:100, spDefense:90, speed: 50, xp: 184, skills: []},
PARAS: {name: 'Paras', tile: new ut.Tile('p', 255, 85, 85), aggressive: false, type: Types.BUG, hp: 35, attack:70, defense: 55, spAttack:45, spDefense:55, speed: 25, xp: 70, skills: []},
PARASECT: {name: 'Parasect', tile: new ut.Tile('P', 255, 85, 85), aggressive: true, type: Types.BUG, hp: 60, attack:95, defense: 80, spAttack:60, spDefense:80, speed: 30, xp: 128, skills: []},
VENONAT: {name: 'Venonat', tile: new ut.Tile('v', 170, 0, 170), aggressive: true, type: Types.BUG, hp: 60, attack:55, defense: 50, spAttack:40, spDefense:55, speed: 45, xp: 75, skills: []},
VENOMOTH: {name: 'Venomoth', tile: new ut.Tile('v', 170, 0, 170), aggressive: true, type: Types.BUG, hp: 70, attack:65, defense: 60, spAttack:90, spDefense:75, speed: 90, xp: 138, skills: []},
...
POLIWRATH: {name: 'Poliwrath', tile: new ut.Tile('P', 85, 85, 255), aggressive: true, type: Types.WATER, hp: 90, attack:85, defense: 95, spAttack:70, spDefense:90, speed: 70, xp: 185, skills: []},
...
BELLSPROUT: {name: 'Bellsprout', tile: new ut.Tile('b', 85, 255, 85), aggressive: false, type: Types.GRASS, hp: 50, attack:75, defense: 35, spAttack:70, spDefense:30, speed: 40, xp: 84, skills: []},
WEEPINBELL: {name: 'Weepinbell', tile: new ut.Tile('w', 85, 255, 85), aggressive: false, type: Types.GRASS, hp: 65, attack:90, defense: 50, spAttack:85, spDefense:45, speed: 55, xp: 151, skills: []},
VICTREEBEL: {name: 'Victreebel', tile: new ut.Tile('V', 85, 255, 85), aggressive: true, type: Types.GRASS, hp: 80, attack:105, defense: 65, spAttack:100, spDefense:60, speed: 70, xp: 191, skills: []},
TENTACOOL: {name: 'Tentacool', tile: new ut.Tile('t', 85, 85, 255), aggressive: true, type: Types.WATER, hp: 40, attack:40, defense: 35, spAttack:50, spDefense:100, speed: 70, xp: 105, skills: []},
TENTACRUEL: {name: 'Tentacruel', tile: new ut.Tile('t', 85, 85, 255), aggressive: true, type: Types.WATER, hp: 80, attack:70, defense: 65, spAttack:80, spDefense:120, speed: 100, xp: 205, skills: []},
GEODUDE: {name: 'Geodude', tile: new ut.Tile('g', 170, 85, 0), aggressive: true, type: Types.ROCK, hp: 40, attack:80, defense: 100, spAttack:30, spDefense:30, speed: 20, xp: 86, skills: []},
GRAVELER: {name: 'Graveler', tile: new ut.Tile('G', 170, 85, 0), aggressive: true, type: Types.ROCK, hp: 55, attack:95, defense: 115, spAttack:45, spDefense:45, speed: 35, xp: 134, skills: []},
GOLEM: {name: 'Golem', tile: new ut.Tile('G', 170, 85, 0), aggressive: true, type: Types.ROCK, hp: 80, attack:110, defense: 130, spAttack:55, spDefense:65, speed: 45, xp: 177, skills: []},
...
SLOWPOKE: {name: 'Slowpoke', tile: new ut.Tile('s', 255, 85, 255), aggressive: false, type: Types.WATER, hp: 90, attack:65, defense: 65, spAttack:40, spDefense:40, speed: 15, xp: 99, skills: []},
SLOWBRO: {name: 'Slowbro', tile: new ut.Tile('s', 255, 85, 255), aggressive: false, type: Types.WATER, hp: 95, attack:75, defense: 110, spAttack:100, spDefense:80, speed: 30, xp: 164, skills: []},
MAGNEMITE: {name: 'Magnemite', tile: new ut.Tile('m', 170, 170, 170), aggressive: true, type: Types.ELECTRIC, hp: 25, attack:35, defense: 70, spAttack:95, spDefense:55, speed: 45, xp: 89, skills: []},
MAGNETON: {name: 'Magneton', tile: new ut.Tile('m', 170, 170, 170), aggressive: true, type: Types.ELECTRIC, hp: 50, attack:60, defense: 95, spAttack:120, spDefense:70, speed: 70, xp: 161, skills: []},
FARFETCHD: {name: 'Farfetch\'d', tile: new ut.Tile('f', 170, 85, 0), aggressive: true, type: Types.NORMAL, hp: 52, attack:65, defense: 55, spAttack:58, spDefense:62, speed: 60, xp: 94, skills: []},
DODUO: {name: 'Doduo', tile: new ut.Tile('d', 170, 85, 0), aggressive: true, type: Types.NORMAL, hp: 35, attack:85, defense: 45, spAttack:35, spDefense:35, speed: 75, xp: 96, skills: []},
DODRIO: {name: 'Dodrio', tile: new ut.Tile('d', 170, 85, 0), aggressive: true, type: Types.NORMAL, hp: 60, attack:110, defense: 70, spAttack:60, spDefense:60, speed: 100, xp: 158, skills: []},
...
DEWGONG: {name: 'Dewgong', tile: new ut.Tile('d', 255, 255, 255), aggressive: true, type: Types.WATER, hp: 90, attack:70, defense: 80, spAttack:70, spDefense:95, speed: 70, xp: 176, skills: []},
...
CLOYSTER: {name: 'Cloyster', tile: new ut.Tile('c', 170, 0, 170), aggressive: true, type: Types.WATER, hp: 50, attack:90, defense: 180, spAttack:85, spDefense:45, speed: 70, xp: 203, skills: []},
GASTLY: {name: 'Gastly', tile: new ut.Tile('g', 170, 0, 170), aggressive: true, type: Types.GHOST, hp: 30, attack:35, defense: 30, spAttack:100, spDefense:35, speed: 80, xp: 95, skills: []},
HAUNTER: {name: 'Haunter', tile: new ut.Tile('h', 170, 0, 170), aggressive: true, type: Types.GHOST, hp: 45, attack:50, defense: 45, spAttack:115, spDefense:55, speed: 95, xp: 126, skills: []},
GENGAR: {name: 'Gengar', tile: new ut.Tile('G', 170, 0, 170), aggressive: true, type: Types.GHOST, hp: 60, attack:65, defense: 60, spAttack:130, spDefense:75, speed: 110, xp: 190, skills: []},
ONIX: {name: 'Onix', tile: new ut.Tile('O', 170, 170, 170), aggressive: true, type: Types.ROCK, hp: 35, attack:45, defense: 160, spAttack:30, spDefense:45, speed: 70, xp: 108, skills: []},
...
EXEGGCUTE: {name: 'Exeggcute', tile: new ut.Tile('e', 255, 85, 255), aggressive: true, type: Types.GRASS, hp: 60, attack:40, defense: 80, spAttack:60, spDefense:45, speed: 40, xp: 98, skills: []},
EXEGGUTOR: {name: 'Exeggutor', tile: new ut.Tile('E', 255, 255, 85), aggressive: true, type: Types.GRASS, hp: 95, attack:95, defense: 85, spAttack:125, spDefense:65, speed: 55, xp: 212, skills: []},
...
RHYHORN: {name: 'Rhyhorn', tile: new ut.Tile('R', 170, 170, 170), aggressive: true, type: Types.GROUND, hp: 80, attack:85, defense: 95, spAttack:30, spDefense:30, speed: 25, xp: 135, skills: []},
RHYDON: {name: 'Rhydon', tile: new ut.Tile('R', 170, 170, 170), aggressive: true, type: Types.GROUND, hp: 105, attack:130, defense: 120, spAttack:45, spDefense:45, speed: 40, xp: 204, skills: []},
...
STARMIE: {name: 'Starmie', tile: new ut.Tile('s', 170, 0, 170), aggressive: true, type: Types.WATER, hp: 60, attack:75, defense: 85, spAttack:100, spDefense:85, speed: 115, xp: 207, skills: []},
...
SCYTHER: {name: 'Scyther', tile: new ut.Tile('s', 85, 255, 85), aggressive: true, type: Types.BUG, hp: 70, attack:110, defense: 80, spAttack:55, spDefense:80, speed: 105, xp: 187, skills: []},
JYNX: {name: 'Jynx', tile: new ut.Tile('j', 255, 85, 85), aggressive: false, type: Types.ICE, hp: 65, attack:50, defense: 35, spAttack:115, spDefense:95, speed: 95, xp: 137, skills: []},
...
GYARADOS: {name: 'Gyarados', tile: new ut.Tile('G', 85, 85, 255), aggressive: true, type: Types.WATER, hp: 95, attack:125, defense: 79, spAttack:60, spDefense:100, speed: 81, xp: 214, skills: []},
LAPRAS: {name: 'Lapras', tile: new ut.Tile('L', 85, 85, 255), aggressive: true, type: Types.WATER, hp: 130, attack:85, defense: 80, spAttack:85, spDefense:95, speed: 60, xp: 219, skills: []},
...
OMANYTE: {name: 'Omanyte', tile: new ut.Tile('o', 85, 85, 255), aggressive: true, type: Types.ROCK, hp: 35, attack:40, defense: 100, spAttack:90, spDefense:55, speed: 35, xp: 120, skills: []},
OMASTAR: {name: 'Omastar', tile: new ut.Tile('o', 85, 85, 255), aggressive: true, type: Types.ROCK, hp: 70, attack:60, defense: 125, spAttack:115, spDefense:70, speed: 55, xp: 199, skills: []},
KABUTO: {name: 'Kabuto', tile: new ut.Tile('k', 170, 85, 0), aggressive: true, type: Types.ROCK, hp: 30, attack:80, defense: 90, spAttack:55, spDefense:45, speed: 55, xp: 119, skills: []},
KABUTOPS: {name: 'Kabutops', tile: new ut.Tile('K', 170, 85, 0), aggressive: true, type: Types.ROCK, hp: 60, attack:115, defense: 105, spAttack:65, spDefense:70, speed: 80, xp: 201, skills: []},
AERODACTYL: {name: 'Aerodactyl', tile: new ut.Tile('A', 170, 0, 170), aggressive: true, type: Types.ROCK, hp: 80, attack:105, defense: 65, spAttack:60, spDefense:75, speed: 130, xp: 202, skills: []},
...
ARTICUNO: {name: 'Articuno', tile: new ut.Tile('A', 85, 85, 255), aggressive: true, type: Types.ICE, hp: 90, attack:85, defense: 100, spAttack:95, spDefense:125, speed: 85, xp: 215, skills: []},
ZAPDOS: {name: 'Zapdos', tile: new ut.Tile('Z', 255, 255, 85), aggressive: true, type: Types.ELECTRIC, hp: 90, attack:90, defense: 85, spAttack:125, spDefense:90, speed: 100, xp: 216, skills: []},
MOLTRES: {name: 'Moltres', tile: new ut.Tile('M', 255, 255, 85), aggressive: true, type: Types.FIRE, hp: 90, attack:100, defense: 90, spAttack:125, spDefense:85, speed: 90, xp: 217, skills: []},
...
DRAGONITE: {name: 'Dragonite', tile: new ut.Tile('D', 170, 85, 0), aggressive: true, type: Types.DRAGON, hp: 91, attack:134, defense: 95, spAttack:100, spDefense:100, speed: 80, xp: 218, skills: []},
